...
export default function Peshawar() {
  ...
  const showBill = () => {
    ...
    if (!refNumber && !custId) {
      ...
      window.open("https://bill.pitc.com.pk/pescobill", "_blank");
    }
  };
  ...
  return (
    ...
    <div className="min-h-screen bg-white flex items-center justify-center lg:ml-2">
      <div className="w-full lg:px-2   sm:px-4">
        <div className="w-full max-w-3xl bg-white px-8 py-10"></div>
        <h2 className="text-xl md:text-2xl font-bold text-center mb-4">
          PESCO Bill Online June 2025
        </h2>
        <p className="text-gray-700 text-sm text-center mb-6">
          GESCOBILL.PK is a free website where you can check your IESCO bill and
        ...
        <img
          src="https://iescosite.s3.amazonaws.com/pesco-bill-reference.jpg"
          alt="IESCO Bill"
        ...
        <p className="text-gray-700">
          ...
          <p>
            ...
            the administrative districts of Rawalpindi, Chakwal, Attock, Jhelum
