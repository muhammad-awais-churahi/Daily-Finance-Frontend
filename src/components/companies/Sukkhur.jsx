...
export default function Sukkhur() {
  ...
  const showBill = () => {
    ...
    if (!refNumber && !custId) {
      ...
      window.open("https://bill.pitc.com.pk/sepcobill", "_blank");
    }
  };
      ...
      <div className="w-full lg:px-2   sm:px-4">
        <div className="w-full max-w-3xl bg-white px-8 py-10">
          <h2 className="text-xl md:text-2xl font-bold text-center mb-4">
            SEPCO Bill Online June 2025
          </h2>
          <p className="text-gray-700 text-sm text-center mb-6">
            SESCOBILL.PK is a free website where you can check your IESCO bill
          ...
          <img
            src="https://iescobill.pk/images/sepco-bill.jpg"
            alt="IESCO Bill"
