...
export default function Hyderabad() {
  ...
  const showBill = () => {
    ...
    if (!refNumber && !custId) {
      ...
      window.open("https://bill.pitc.com.pk/hescobill", "_blank");
    }
  };
      ...
      <div className="w-full lg:px-2   sm:px-4">
        <div className="w-full max-w-3xl bg-white px-8 py-10">
          <h2 className="text-xl md:text-2xl font-bold text-center mb-4">
            HESCO Bill Online June 2025
          </h2>
          <p className="text-gray-700 text-sm text-center mb-6">
            HESCOBILL.PK is a free website where you can check your IESCO bill
          ...
          <img
            src="https://iescobill.pk/images/hesco-online-bill.jpg"
            alt="IESCO Bill"
