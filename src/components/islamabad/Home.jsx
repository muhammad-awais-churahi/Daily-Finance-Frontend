...
export default function Home() {
  // const { companySelection } = useParams();
  // console.log("compnay selection:", companySelection);
  // const companyUrl = companySelection.toLowerCase() + "bill";
  ...
  const showBill = () => {
    ...
    if (!refNumber && !custId) {
      ...
      window.open(`https://bill.pitc.com.pk/${companyUrl}`, "_blank");
    }
  };
    ...
    <div className="min-h-screen bg-white flex items-center justify-center  sm:ml-2 sm:mr-2 md:ml-5.5  lg:ml-16 md:mr-2 lg:mr-[32px] xl:ml-32 xl:mr-24 2xl:-ml-[-7px] 2xl:w-[100%] ">
      <div className="w-full max-w-3xl bg-white rounded-lg p-6">
        <h2 className="text-xl md:text-2xl font-bold text-center mb-4">
          IESCO Bill Online June 2025
        </h2>
        <p className="text-gray-700 text-sm text-center mb-6">
          IESCOBILL.PK is a free website where you can check your IESCO bill and
          download a duplicate copy of the bill quite easily. Here you can view
          your current electricity bill (bijli bill), find all information about
          previous bill, check consumer name and all other history about the
          bill.
        </p>
        {/* Form */}
        ...
        <p className="text-lg text-gray-700 mt-4 text-justify">
          ...
          home, office or shop, you can search your bill by Reference Number or
          Customer ID and then download or print a copy of your bill for free.
          IESCOBILL.PK is the first website where you can save your reference
          numbers, and then check your latest bills with single click every
          month.
          <br />
          <br />
          ...
          information by entering 14 digit reference number or 10 digit customer
          id. Consumers can also find out registration record, bill status, bill
          slabs etc. So enter reference number above to check your iesco
          duplicate bill and also check if your previous bill was paid or not in
          the bill history.
        </p>
        <img
        ...
        <p className="text-lg text-gray-700 mt-4 text-justify">
          ...
          appliances consume and how you can reduce electricity bill by turning
          off unnecessary devices. Here is the list of items with estimate units
          of electricity it consumed if used for 24 hours
        </p>
        ...
        <p className="text-gray-700 mb-4">
          So if you want to reduce your electricity bill amount, you must watch
          out how many appliances are being used at a time. Here are some tips
          to reduce electricity bill amount:
        </p>
        <ul className="list-decimal list-inside text-gray-700 space-y-2 mb-6">
          <li>Switch off unnecessary appliances.</li>
          <li>
            Instead of turning on five energy savers, try to manage with four or
            even less.
          </li>
          <li>
        ...
        <p className="text-gray-700">
          ...
          <br />
          It is the date when you initially registered yourself in IESCO’s
          database for electricity connection. It is the date when you initially
          registered yourself in IESCO’s database for electricity connection. It
          is the date when you initially registered yourself in IESCO’s database
        ...
        <p className="text-gray-700">
          It is the date when you initially registered yourself in IESCO’s
          database for electricity connection. It is the date when you initially
          registered yourself in IESCO’s database
          {/* </p> */}
        </p>
        <br />
        <p className="text-gray-700">
        ...
        <p className="text-gray-700">
          ...
          It is the date when you initially registered yourself in IESCO’s
          database for electricity connection. It is the date when you initially
          registered yourself in IESCO’s database.It is the date when you
          initially registered yourself in IESCO’s database
        </p>
        <br />
        <p className="text-gray-700">
          <strong className="text-xl block mb-2">QTR Tariff Adj / DMC:</strong>
          <br />
          It is the date when you initially registered yourself in IESCO’s
          database for electricity connection. It is the date when you initially
          registered yourself in IESCO’s database
        ...
        <p className="text-gray-700">
          ...
          satisfaction, IESCO is divided into 4 circles, 19 divisions and 104
          subdivisions. Superintending Engineers (SEs) are head of Circles
          whereas Divisions are supervised by Executive Engineers (XENs). All
          Subdivisions are managed by Sub Divisional Officers (SDOs) and also
          each division has a Customer Services Officer which is called CSO.
          <br />
          The company takes care of the electricity distribution network in the
          administrative districts of Rawalpindi, Chakwal, Attock, Jhelum and
          Federal Capital Islamabad.
          <br /> The company takes care of the electricity distribution network
          in the administrative districts of Rawalpindi, Chakwal, Attock, Jhelum
          and Federal Capital Islamabad.
        </p>{" "}
        <br />
        ...
        <p>
          {" "}
          For complains, you can visit the billing complaint resolution desk at
          IESCO Head Office located Street # 40 Sector G-7/4 Islamabad. You can
          visit that address and submit your complaints. You can also submit
          your complaintto the IESCO CEO by sending your complaint email to{" "}
          <a
        ...
        <br />
        <p>
          If you are looking for nearest customer services center, you can check
